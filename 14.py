...
train=pd.read_csv("../PythonProject10/train (2).csv")
test=pd.read_csv('../PythonProject10/test (3).csv')
...
submission.to_csv("submission_regression4.csv", index=False)